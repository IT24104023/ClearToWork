    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 selection:bg-amber-500 selection:text-slate-950 flex flex-col font-sans transition-colors">
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-md">
          <TiltCard>
            <div className="p-8 sm:p-10 rounded-3xl bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-2xl backdrop-blur-xl space-y-6">
              {/* Header */}
              <div className="text-center space-y-2">
                <div className="w-12 h-12 mx-auto rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-500 dark:text-amber-400 shadow-lg shadow-amber-500/10">
              ...
              {/* Feedback Alert */}
              {errorMsg && (
                <div className="p-3.5 rounded-xl bg-red-50 dark:bg-red-950/60 border border-red-500/40 text-red-700 dark:text-red-300 text-xs flex items-center space-x-2 animate-in fade-in">
              ...
              {successMsg && (
                <div className="p-3.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-500/40 text-emerald-700 dark:text-emerald-300 text-xs flex items-center space-x-2 animate-in fade-in">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  >
                    ...
                    <option value="SafetyOfficer">{t('role_safety_officer')}</option>
                    <option value="AreaSupervisor">{t('role_area_supervisor')}</option>
                    <option value="Administrator">{t('role_admin')}</option>
                  </select>
                </div>
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-slate-700 dark:text-slate-300 flex items-center space-x-1.5">
                    <Lock className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400" />
                    <span>{t('reg_confirm_password')}</span>
                  </label>
                  <input
                    type="password"
                    required
