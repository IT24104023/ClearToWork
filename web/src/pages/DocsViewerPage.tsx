  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center space-x-3 border-b border-slate-800 pb-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">{t('docs_title')}</h1>
          <p className="text-xs text-slate-400 mt-0.5">{t('docs_subtitle')}</p>
        </div>
      </div>
      ...
      {activeTab === 'arch' && (
        <div className="bg-slate-900 dark:bg-slate-900/80 p-6 rounded-2xl border border-slate-800 space-y-4 text-xs text-slate-300 leading-relaxed shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3 my-4">
            <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-xl">
              <div className="text-[10px] font-mono text-amber-400 font-bold uppercase mb-1">Tier 1: Client</div>
              <div className="font-bold text-white mb-1">React + Vite</div>
            ...
            <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-xl">
              <div className="text-[10px] font-mono text-sky-400 font-bold uppercase mb-1">Tier 2: Backend</div>
              <div className="font-bold text-white mb-1">ASP.NET Core 8 API</div>
              <p className="text-[11px] text-slate-400">
            ...
            <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-xl">
              <div className="text-[10px] font-mono text-emerald-400 font-bold uppercase mb-1">Tier 3: Database</div>
              <div className="font-bold text-white mb-1">EF Core + Relational</div>
              <p className="text-[11px] text-slate-400">
            ...
            <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-xl">
              <div className="text-[10px] font-mono text-purple-400 font-bold uppercase mb-1">Tier 4: Agentic AI</div>
              <div className="font-bold text-white mb-1">LangGraph DAG</div>
              <p className="text-[11px] text-slate-400">
          ...
          <div className="p-4 bg-slate-950/60 border border-slate-800 rounded-xl">
            <div className="font-bold text-white mb-1">Third-Party Integration: Open-Meteo API</div>
            <p className="text-[11px] text-slate-400">
      ...
      {activeTab === 'agents' && (
        <div className="bg-slate-900 dark:bg-slate-900/80 p-6 rounded-2xl border border-slate-800 space-y-4 text-xs text-slate-300 leading-relaxed shadow-md">
          ...
          <div className="space-y-3 mt-3">
            <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-xl flex items-start justify-between">
              <div>
                <div className="font-bold text-white text-xs">1. Planning & Coordination Agent (Student 3)</div>
                <div className="text-[11px] text-slate-400 mt-0.5">
                  Decomposes permit objectives, checks permit type limits, and mandates fire watch.
                </div>
                <div className="text-[10px] font-mono text-sky-400 mt-1">Tools: get_permit_type_template()</div>
              </div>
              <span className="text-[10px] bg-sky-950 text-sky-300 px-2 py-0.5 rounded font-mono">Node 1</span>
            </div>

            <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-xl flex items-start justify-between">
              <div>
                <div className="font-bold text-white text-xs">2. Personnel & Competency Agent (Student 1)</div>
                <div className="text-[11px] text-slate-400 mt-0.5">
                  Audits worker badges against national trade certifications. Flags expiries and suggests qualified replacement workers.
                </div>
                <div className="text-[10px] font-mono text-sky-400 mt-1">Tools: get_worker_certificates(), find_eligible_workers()</div>
              </div>
              <span className="text-[10px] bg-sky-950 text-sky-300 px-2 py-0.5 rounded font-mono">Node 2</span>
            </div>

            <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-xl flex items-start justify-between">
              <div>
                <div className="font-bold text-white text-xs">3. Resource & Isolation Agent (Student 2)</div>
                <div className="text-[11px] text-slate-400 mt-0.5">
                  Audits equipment calibration and monthly inspections. Queries Lock-Out / Tag-Out (LOTO) isolation points.
                </div>
                <div className="text-[10px] font-mono text-sky-400 mt-1">Tools: check_equipment_readiness(), get_isolation_points()</div>
              </div>
              <span className="text-[10px] bg-sky-950 text-sky-300 px-2 py-0.5 rounded font-mono">Node 3</span>
            </div>

            <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-xl flex items-start justify-between">
              <div>
                <div className="font-bold text-white text-xs">4. Site Conditions & Hazard Control Agent (Student 4)</div>
                <div className="text-[11px] text-slate-400 mt-0.5">
                  Evaluates SIMOPS clashes across adjacent zones (e.g. Hot Work vs Solvent Painting). Evaluates live Open-Meteo wind gusts.
                </div>
                <div className="text-[10px] font-mono text-sky-400 mt-1">Tools: get_zone_conflicts(), get_weather_forecast()</div>
              </div>
              <span className="text-[10px] bg-sky-950 text-sky-300 px-2 py-0.5 rounded font-mono">Node 4</span>
            </div>

            <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-xl flex items-start justify-between">
              <div>
                <div className="font-bold text-white text-xs">5. Validation & Safety Agent (Shared Engine)</div>
                <div className="text-[11px] text-slate-400 mt-0.5">
                  Enforces fail-safe clearance. If any violation is found, returns REFUSED_SAFE_FAILURE with actionable remediation.
                </div>
                <div className="text-[10px] font-mono text-sky-400 mt-1">Tools: run_permit_validator()</div>
              </div>
              <span className="text-[10px] bg-emerald-950 text-emerald-300 px-2 py-0.5 rounded font-mono">Node 5 (Guardrail)</span>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="bg-slate-900 dark:bg-slate-900/80 p-6 rounded-2xl border border-slate-800 space-y-4 text-xs text-slate-300 leading-relaxed shadow-md">
          ...
          <div className="space-y-3">
            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl">
              <div className="font-bold text-white mb-1">1. JWT Bearer Tokens with HMAC-SHA256</div>
              <p className="text-[11px] text-slate-400">
            ...
            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl">
              <div className="font-bold text-white mb-1">2. Internal Agent Subsystem Isolation</div>
              <p className="text-[11px] text-slate-400">
            ...
            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl">
              <div className="font-bold text-white mb-1">3. Immutable Safety Audit Log</div>
              <p className="text-[11px] text-slate-400">
        ...
        <div className="bg-slate-900 dark:bg-slate-900/80 p-6 rounded-2xl border border-slate-800 space-y-4 text-xs text-slate-300 leading-relaxed shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 my-3">
            <div className="p-3 bg-slate-950 border border-slate-800 rounded-xl">
              <div className="font-bold text-white text-xs">Workforce Domain (Student 1)</div>
            ...
            <div className="p-3 bg-slate-950 border border-slate-800 rounded-xl">
              <div className="font-bold text-white text-xs">Equipment Domain (Student 2)</div>
              <div className="text-[11px] text-slate-400 mt-1 font-mono">
            ...
            <div className="p-3 bg-slate-950 border border-slate-800 rounded-xl">
              <div className="font-bold text-white text-xs">Permits Domain (Student 3)</div>
              <div className="text-[11px] text-slate-400 mt-1 font-mono">
            ...
            <div className="p-3 bg-slate-950 border border-slate-800 rounded-xl">
              <div className="font-bold text-white text-xs">Hazards & SIMOPS (Student 4)</div>
              <div className="text-[11px] text-slate-400 mt-1 font-mono">
